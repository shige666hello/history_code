...
const onDetectAreasClick = function (e) {
  resetTableAreas();
...
const onAddSeparatorClick = function (e) {
  columnCountBuffer++;
...
const onColumnSeparatorDoubleClick = function (e) {
...
const startJob = function () {
  ...
  $.ajax({
    ...
    type: 'POST',
    success: function (data) {
      const redirectUrl = `${window.location.protocol}//${window.location.host}/jobs/${data['job_id']}`;
