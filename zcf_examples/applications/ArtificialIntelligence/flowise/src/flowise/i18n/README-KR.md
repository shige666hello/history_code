...
3. [http://localhost:8080](http://localhost:8080) URL 열기
...
4. [http://localhost:8080](http://localhost:8080) URL 열기
...
2. 이미지 실행하기:
    ...
    ```bash
    docker run -d --name flowise -p 8080:8080 flowise
    ```
...
5. 애플리케이션 시작:
    ...
    이제 [http://localhost:8080](http://localhost:8080)에서 애플리케이션에 접속할 수 있습니다.
