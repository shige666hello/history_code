...
3. [http://localhost:8080](http://localhost:8080) を開く
...
4. [http://localhost:8080](http://localhost:8080) を開く
...
5. アプリを起動:
    ...
    [http://localhost:8080](http://localhost:8080) でアプリにアクセスできるようになりました
