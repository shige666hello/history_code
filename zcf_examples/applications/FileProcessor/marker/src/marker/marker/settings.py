...
class Settings(BaseSettings):
    ...
    INFERENCE_RAM: int = 8 # How much VRAM each GPU has (in GB).
    ...
    OCR_ENGINE: Optional[Literal["surya", "ocrmypdf"]] = "ocrmypdf" # Which OCR engine to use, either "surya" or "ocrmypdf".  Defaults to "ocrmypdf" on CPU, "surya" on GPU.
